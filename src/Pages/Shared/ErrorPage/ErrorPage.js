        ...
        <section className="flex items-center h-screen p-16 bg-gray-100 text-gray-900">
            <div className="container flex flex-col items-center justify-center px-5 mx-auto my-8">
                ...
                <div className="max-w-md text-center">
                    ...
                    <p className="text-2xl text-red-400 font-semibold md:text-3xl mb-8">
                        {error.statusText || error.message}
                    </p>
                    <h2 className="text-2xl mb-8">Please <button onClick={handleLogOut} className="btn btn-primary bg-gradient-to-r from-primary to-secondary text-white">Log Out</button> and log back in </h2>
                    <Link
                        to="/"
                         className="btn btn-primary bg-gradient-to-r from-primary to-secondary text-white">Back to homepage
